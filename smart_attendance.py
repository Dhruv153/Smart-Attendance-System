...
"""
from tkinter import END, Button, Entry, Label, PhotoImage
...
root = tk.Tk()
# photo = tk.PhotoImage(file = 'icon.jpg')
...
btn3 = Button(root, text = 'Save',font='arial',bg='dark grey',command = setTextInput1) # this create submit button of entry box, it submit the mail
...
def Capture():
    ...
    global btn2
    btn2 = Button(root, text = 'save!',font ='arial',bg='dark grey', bd = '12',command = setTextInput,width=15)# this button save student information 
    ...
    def Run():
        ...
        while True: 
                            ...
                            while timer >= 0: 
                                            ...
                                            cv2.destroyAllWindows()
    global btn5                                      
    btn5 = Button(root, text = 'Capture the image for enroll',bg='black',fg='white',width=25,height=2,font='arial',command = Run) # this button help to enroll the face of the student
    btn5.place(x=50,y=600)

btn = Button(root, text = 'Enroll the faces',font='arial',fg='white',width=15,height=2,bg='black',command = Capture) # this button enroll the student information to database 
btn.place(x=50, y=230)

btn1 = Button(root, text = 'Start attendance',font='arial' ,fg='white',bg='black',width=16,height=2,command = Start)  # this button start face recognition to take attendance 
...
btn7 = Button(root, text = 'Generate database',bg='black',fg='white',width=25,height=2,font='arial',command = setTextInput2)
...
btn6 = Button(root, text = 'Reset',fg='white', font='arial',bg='black',width=15,height=2,command = reset) # this button destroy buttons and labels
